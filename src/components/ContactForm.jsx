              ...
              {contactInfo.map(({ Icon, label, href }, i) => {
                const inner = (
                  <div
                    style={{
                      ...
                      gap: 16,
                      padding: '20px 0',
                      borderBottom: i < contactInfo.length - 1 ? '1px solid #1a1a1a' : 'none',
                    }}
                  >
                    <div style={{
                      ...
                      <Icon size={15} color="#424242" strokeWidth={1.75} />
                    </div>
                    <span style={{
                      fontFamily: "'JetBrains Mono', monospace",
                ...
                return href ? (
                  <a
                    ...
                    style={{ textDecoration: 'none', display: 'block', transition: 'opacity 0.15s ease' }}
